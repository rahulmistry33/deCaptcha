...
json_file = open('./crackCaptcha/Shadow_CNN_RNN_Model.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
model = model_from_json(loaded_model_json,custom_objects={'CTCLayer': CTCLayer})
# load weights into new model
model.load_weights("./crackCaptcha/Shadow_CNN_RNN_Model.h5")
opt = optimizers.Adam()
...
characters = ['5', 'e', '6', 'f', 'w', 'b', 'r', '3', 'x', '2', 'p', '4', 'y', 'd', '7', 'n', 'm', 'k', 'c', '8', 'g', 'a', 'h']
...
def predict_shadow_cnn_rnn(url_list):
    images = []
    for url in url_list:
