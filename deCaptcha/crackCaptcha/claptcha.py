...
class Claptcha(object):
    ...
    def __init__(self, source, font,color=[255,255,255],textColor = [0,0,0],lineColor = [255,255,255],
    ...
    def _writeText(self, image, text, pos):
        ...
        for c in text:
            ...
            c_draw.text((0, 0), c, font=self.font, fill=(textColor[0],textColor[1],textColor[2], 255))
    ...
    def _drawLine(self, image):
        ...
        # Draw
        l_draw.line(((x1, y1), (x2, y2)), fill=(lineColor[0],lineColor[1],lineColor[2], 255), width=l_width)
