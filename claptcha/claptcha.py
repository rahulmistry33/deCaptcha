...
class Claptcha(object):
    ...
    def image(self):
        ...
        # Random RGBA for text & lines
        
        colors = [(255,0,0,255), (11,195,1,255), (0,0,255,255)]
        fillRGBA = colors[random.randint(0,2)]
        # Text
        self._writeText(image, text, pos=(margin_x, margin_y), fillRGBA=fillRGBA)

        # Line
        self._drawLine(image, fillRGBA)
        ...
        image = random_noise(np.array(image), mode='s&p',amount=0.05)
    ...
    def _writeText(self, image, text, pos, fillRGBA):
        ...
        for c in text:
            ...
            c_draw.text((0, 0), c, font=self.font, fill=fillRGBA)
    ...
    def _drawLine(self, image, fillRGBA):
        ...
        # Draw
        l_draw.line(((x1, y1), (x2, y2)), fill=fillRGBA, width=l_width)
